...
:link-use-jekyll-asciidoc-for-gitlab-pages: https://github.com/asciidoctor/jekyll-asciidoc#using-this-plugin-on-gitlab-pages[documentation in README of jekyll-asciidoc]
...
by GitLab (see {link-use-jekyll-asciidoc-for-gitlab-pages}).
...
. Open a shell to the running container and start runner configuration:
+
[source,]
...
[FIXME: Enter your token from GitLabs runner configuration]
